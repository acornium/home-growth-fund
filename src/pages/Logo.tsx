    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="grid gap-6 md:grid-cols-2 mb-12">
        <div className="flex items-center justify-center p-12 rounded-lg border border-border bg-white">
          <img src="/logo-smart-group.png" alt="Логотип на белом фоне" className="max-h-32 object-contain" />
        </div>
        <div className="flex items-center justify-center p-12 rounded-lg bg-primary">
          <img src="/logo-smart-group.png" alt="Логотип на тёмном фоне" className="max-h-32 object-contain brightness-0 invert" />
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-16 rounded-lg border border-border mb-12 bg-muted/30">
        <div className="relative border-2 border-dashed border-primary/30 p-10">
          <img src="/logo-smart-group.png" alt="Охранное поле логотипа" className="h-16 object-contain" />
      ...
      <div className="flex items-center gap-8 mb-12">
        <div className="text-center">
          <img src="/logo-smart-group.png" alt="Минимальный размер" className="h-6 object-contain mb-2" />
