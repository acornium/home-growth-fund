...
const Logo = () => {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <h1 className="text-4xl font-display font-bold text-foreground mb-8">Логотип</h1>

      {/* Main logo */}
      <h2 className="text-2xl font-display font-semibold mb-4">Основная версия</h2>
      <div className="grid gap-6 md:grid-cols-2 mb-12">
        <div className="flex items-center justify-center p-12 rounded-lg border border-border bg-white">
          <img src={`${import.meta.env.BASE_URL}logo-smart-group.png`} alt="Логотип на белом фоне" className="max-h-32 object-contain" />
        </div>
        <div className="flex items-center justify-center p-12 rounded-lg bg-primary">
          <img src={`${import.meta.env.BASE_URL}logo-smart-group.png`} alt="Логотип на тёмном фоне" className="max-h-32 object-contain brightness-0 invert" />
        </div>
      </div>

      {/* Clear space */}
      <h2 className="text-2xl font-display font-semibold mb-4">Охранное поле</h2>
      ...
      <div className="flex items-center justify-center p-16 rounded-lg border border-border mb-12 bg-muted/30">
        <div className="relative border-2 border-dashed border-primary/30 p-10">
          <img src={`${import.meta.env.BASE_URL}logo-smart-group.png`} alt="Охранное поле логотипа" className="h-16 object-contain" />
      ...
      {/* Min size */}
      <h2 className="text-2xl font-display font-semibold mb-4">Минимальный размер</h2>
      <p className="text-muted-foreground mb-6 leading-relaxed">
      ...
      <div className="flex items-center gap-8 mb-12">
        <div className="text-center">
          <img src={`${import.meta.env.BASE_URL}logo-smart-group.png`} alt="Минимальный размер" className="h-6 object-contain mb-2" />
          <span className="text-xs text-muted-foreground font-mono">80px / 24mm</span>
        </div>
      </div>

      {/* Wrong usage */}
      <h2 className="text-2xl font-display font-semibold mb-4">Недопустимое использование</h2>
        ...
        {[
          ...
          <div key={item.label} className="relative flex flex-col items-center justify-center p-8 rounded-lg border border-destructive/20 bg-destructive/5">
            ...
            <img
              ...
              style={{ filter: item.style.includes("hue") ? `${item.style}` : undefined, transform: item.style.includes("scale") || item.style.includes("rotate") ? item.style.replace("scale-x-150", "scaleX(1.5)").replace("rotate-45", "rotate(45deg)") : undefined }}
            />
